...
SELECT
    ...
    a.dim_3,
    a.dim_4
INTO OUTFILE '/Users/jshier/Development/School/jcura/sample_analysis/db_utils/output_pca_sn.csv'
...
WHERE
    s.sample_type = 'sn' AND s.exclude = 0 AND p.exclude = 0 AND a.window_length=-1;
