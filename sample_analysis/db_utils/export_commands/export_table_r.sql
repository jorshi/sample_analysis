...
SELECT 'Index', 'Drum Machine', 'Type', 'Sample', 'Duration', 'Equal Loudness', 'RMS', 'Temporal Centroid', 'Spectral Centroid', 'Spectral Kurtosis', 'Pitch Salience'
UNION ALL
SELECT
    s.id,
    p.name, 
...
INTO OUTFILE '/Users/jshier/Development/School/jcura/sample_analysis/db_utils/output.csv'
    ...
    LINES TERMINATED BY '\n'
FROM analysis_analysisrobustscale a 
